...
Step     | Description
-------- | -----
![](./Media/Orange1.png) | Review the Azure Logic App logic that retrieve crypto stock transaction stream sent to EventHubs
![](./Media/Orange2.png) | Save scrypto stock transaction messages into your data lake for future analysis (cold path)
...
![](./Lab/Lab5/Media/Screen Shot 2022-05-25 at 11.54.50 pm.png)
